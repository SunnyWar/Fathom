...
use rfathom::{Tablebase, Color, WdlValue};
    ...
    match tb.probe_wdl(
        ...
        Some(wdl) => {
            ...
            match wdl {
                ...
                WdlValue::CursedWin => println!("Position is winning but can be drawn by the 50-move rule"),
                WdlValue::Draw => println!("Position is drawn"),
                WdlValue::BlessedLoss => println!("Position is losing but can be drawn by the 50-move rule"),
